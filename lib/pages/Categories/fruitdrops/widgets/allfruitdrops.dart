...
class AllFruitDrop extends StatelessWidget {
  @override
      ...
      slivers: [
        ...
        StreamBuilder(
            stream: FirebaseFirestore.instance
                .collection("items")
                .where("shortInfo", isEqualTo: "Fruit Drop")
                .snapshots(),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: NetworkImage(
                      "https://firebasestorage.googleapis.com/v0/b/loan-app-6d0b2.appspot.com/o/ecommerceImages%2FJumboTron%2FfruitDropJumbo.jpeg?alt=media&token=9b6adaef-1b54-4bed-a1cc-5428a4bf3d4d"),
                  fit: BoxFit.cover,
                ),
              ),
            ),
